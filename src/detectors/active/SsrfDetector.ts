...
export class SsrfDetector implements IActiveDetector {
  ...
  readonly description =
    'Detects Server-Side Request Forgery by injecting internal and cloud metadata URLs';
    ...
    for (const payload of payloads) {
      try {
        ...
        if (
          ...
          return this.createVuln(
            surface,
            payload,
            result,
            'Critical SSRF: Cloud/Local Access',
  ...
  private createVuln(
    ...
    return {
      ...
      remediation:
        'Validate and sanitize all user-supplied URLs. Use an allowlist of permitted domains. Disable unused URL schemes (file://).',
